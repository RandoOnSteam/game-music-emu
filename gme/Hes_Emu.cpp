...
struct Hes_File : Gme_Info_
{
	...
	{
		BOOST_STATIC_ASSERT( offsetof (header_t,fields) == Hes_Emu::header_size + 0x20, "HES header layout is incorrect!" );
...
{
	BOOST_STATIC_ASSERT( offsetof (header_t,unused [4]) == header_size, "HES header layout is incorrect!" );
